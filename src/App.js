...
class App extends Component {
	constructor() {
		super();
		var action = ['Adventure', 'Fun', 'Excitement', 'the Future', 'Bravery', 'Loyalty', 'Honor'];
		var wait = ['wait', 'hold on tight', 'check your bags', 'dont change that channel', 'stand by', 'bear with me', 'rise', 'silence all cell phones and pagers'];
		this.state = {
